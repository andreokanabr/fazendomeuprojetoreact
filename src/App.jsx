		...
		<div className="bg-slate-950 text-slate-100 selection:bg-fuchsia-500/30">
			...
			<section className="relative overflow-hidden">
				<div className="mx-auto max-w-6xl px-4 py-20 relative">
					...
					<motion.p
						...
						Atque unde, in aperiam alias voluptatibus non vitae qui
						asperiores.
					</motion.p>{" "}
					<motion.div
						initial={{ opacity: 0, y: 20 }}
              ...
              transition">
					...
					<motion.div
						...
						{["Velocidade", "Segurança", "Conversão"].map(
							(label, i) => (
								<div
									key={label}
			...
			<section id="features" className="mx-auto max-w-6xl px-4 py-8">
				...
				<p className="text-slate-300 mt-2 max-w-2xl">
					Lorem ipsum, dolor sit amet consectetur adipisicing elit.
					Fugiat eius saepe a ex aliquam veniam hic porro?
				</p>
				<div
					className="
					...
					{[1, 2, 3].map((i) => (
						<blockquote
							...
							<p className="mt-3 text-slate-300">
								Lorem ipsum dolor sit amet, consectetur
								adipisicing elit. Nulla quaerat sequi
								praesentium, ab ut officia veniam mollitia
								doloremque debitis excepturi.
							</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
					<div>
						...
						<p className="text-slate-300 mt-6 max-w-2xl">
							...
							elit. Fugiat eius saepe a ex aliquam veniam hic
							porro?
						</p>
